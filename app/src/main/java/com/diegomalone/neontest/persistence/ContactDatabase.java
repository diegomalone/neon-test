...
public class ContactDatabase {
    ...
    public static List<Contact> getContactList() {
        ...
        contactList.add(new Contact("5", "Jimmy McGill (Saul Goldman)", "(505) 842-5325", "https://vignette.wikia.nocookie.net/breakingbad/images/5/56/BCS_S3_JimmyMcGill.jpg/revision/latest/scale-to-width-down/350?cb=20170327184952"));
        ...
        contactList.add(new Contact("13", "Chuck McGill", "(505) 884-1120", "https://vignette.wikia.nocookie.net/breakingbad/images/3/3e/BCS_S3_ChuckMcGill.jpg/revision/latest/scale-to-width-down/350?cb=20170327185308"));
    ...
    public static List<Contact> getContactListWithTransfers() {
        List<Contact> contactList = getContactList();

        contactList.get(0).setTransferredValue(1442);
        contactList.get(1).setTransferredValue(120);
        contactList.get(4).setTransferredValue(88);
        contactList.get(6).setTransferredValue(210);
