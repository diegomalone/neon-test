...
public class MemoryDatabaseInterface implements DatabaseInterface {
    ...
    private List<Contact> setupContactList() {
        ...
        contactList.add(new Contact(5, "Jimmy McGill (Saul Goodman)", "(505) 842-5325", "https://vignette.wikia.nocookie.net/breakingbad/images/5/56/BCS_S3_JimmyMcGill.jpg/revision/latest/scale-to-width-down/350?cb=20170327184952"));
